...
<div class="container-fluid" id="pcont">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('dashboards')}}">Home</a></li>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="block-flat">
                        ...
                        <div class="content">
                            ...
                            <form class="form-horizontal group-border-dashed"  action="{{route('store')}}" method="post">
                            @csrf
                            <input type="hidden"  name="user_id" value="{{auth()->user()->id}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text"   class="form-control" id="city" placeholder="City/Town" name="city">
                                    </div>
                                </div>
...
<option value="ZW">Zimbabwe</option>                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text"  class="form-control" id="phone" placeholder="Phone" name="number">
                                    </div>
                                </div>
